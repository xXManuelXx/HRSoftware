 ...
 */
@Stateless
public class GehaltsabrechnungvariableeingabenService extends AbstractService<Gehaltsabrechnungvariableeingaben> {
    ...
    public GehaltsabrechnungvariableeingabenService() {
