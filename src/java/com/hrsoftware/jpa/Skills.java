...
@NamedQueries({
    ...
    , @NamedQuery(name = "Skills.findByBeschreibung", query = "SELECT s FROM Skills s WHERE s.beschreibung = :beschreibung")})
public class Skills implements Serializable {
    ...
    @JoinTable(name = "ma_skills", joinColumns = {
    ...
    public Skills(Integer id, String beschreibung) {
        this.id = id;
    ...
    public String toString() {
        return "com.hrsoftware.jpa.Skills[ id=" + id + " ]";
    }
