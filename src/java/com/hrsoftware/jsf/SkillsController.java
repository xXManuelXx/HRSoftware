...
import com.hrsoftware.jpacontroller.SkillsFacade;
...
public class SkillsController implements Serializable {
    ...
    @EJB
    private com.hrsoftware.jpacontroller.SkillsFacade ejbFacade;
    ...
    public void setSelected(Skills selected) {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("SkillsCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("SkillsUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("SkillsDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Skills> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Skills> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class SkillsControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Skills) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Skills.class.getName()});
                return null;
            }
        }
